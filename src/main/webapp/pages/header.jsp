            ...
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                     ...
                     <li>
                        <a href="#"><i class="fa fa-edit fa-fw"></i> 标记列表<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                     ...
                     <li>
                        <a href="#"><i class="fa fa-edit fa-fw"></i> 学院列表<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="<%=basePath%>pages/back/xueyuan/xueyaun_insert.jsp">增加学院</a>
                            </li>
                            <li>
