...
<div id="page-wrapper">
    ...
    <button class="btn btn-danger btn-sm" id="deleteBtn3">批量删除</button>
        <div class="text-right">
            <ul class="pagination pagination-sm" id="pagecontrol"></ul>
        </div>
        <div class="alert alert-success" id="alertDiv2" style="display: none">
            <button class="close" data-dismiss="alert">&times;</button>
            <span id="alertText2"></span>
        </div>
    </div>

<div class="modal" id="xueyuanInfo">
